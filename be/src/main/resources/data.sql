...
VALUES (1, '디지털기기', 'www.imgurl1.com'),
...
VALUES (1, 1, 'www.itemimageurl1.com'),
...
VALUES (1, 18, 2, 1, '2022-06-30 13:13:56', 'Quas.', 'Nesciunt suscipit ipsa deleniti.', 63013, 24, '판매중'),
       ...
       (3, 8, 4, 5, '2023-06-13 09:11:37', 'Eius.', 'Dignissimos at accusantium eum recusandae ipsam.', 28937, 11,
        '예약중'),
       (1, 10, 4, 6, '2022-10-03 03:12:18', 'Nam animi.', 'Nemo ex fugiat atque sunt voluptate minus.', 380813, 27,
        '예약중'),
       (1, 3, 2, 7, '2022-11-29 17:23:44', 'Dolorem.', 'Est error accusamus praesentium nesciunt.', 782579, 14, '예약중'),
       (3, 11, 2, 8, '2023-03-16 19:10:37', 'Nemo aut.', 'Optio facere impedit cum qui dolorum assumenda.', 456920, 16,
        '예약중'),
       ...
       (3, 16, 3, 12, '2022-12-15 18:14:32', 'Excepturi.', 'Reiciendis iusto totam. Nam molestias nesciunt.', 91618, 17,
        '판매중'),
       ...
       (6, 7, 1, 19, '2023-05-18 09:47:11', 'Suscipit.', 'Quaerat soluta dolor cum eaque eligendi enim.', 782889, 16,
        '예약중'),
       ...
       (5, 4, 4, 24, '2023-05-11 19:11:16', 'Nobis.', 'Excepturi reprehenderit assumenda consequatur.', 145118, 5,
        '판매중'),
       (1, 10, 2, 25, '2022-12-23 21:33:48', 'Quaerat.', 'NULL', 226762, 23, '판매중'),
       (5, 8, 5, 26, '2023-03-17 09:03:19', 'Quo.', 'Illo quibusdam neque tempora commodi porro omnis.', 782564, 5,
        '판매중'),
       ...
       (4, 18, 4, 29, '2023-01-31 15:54:55', 'Libero id.', 'Praesentium eveniet modi voluptas velit dolorem.', 726874,
        26, '예약중'),
       ...
       (3, 9, 3, 38, '2022-11-02 03:02:41', 'Quasi.', 'Ab mollitia facilis consequuntur voluptates esse.', 957248, 29,
        '예약중'),
       ...
       (2, 1, 4, 41, '2022-10-29 13:50:34', 'Hic.', 'Alias corporis saepe. Veniam perferendis nobis.', 666125, 15,
        '판매중'),
       ...
       (3, 14, 1, 45, '2023-04-08 10:37:31', 'Non.', 'Aperiam impedit officia explicabo laudantium.', 543583, 16,
        '예약중'),
       ...
       (5, 1, 2, 55, '2022-11-16 06:02:06', 'Odio.', 'Sequi tenetur cupiditate quis porro unde facilis.', 412116, 9,
        '판매중'),
       ...
       (2, 7, 6, 58, '2022-08-24 06:46:23', 'Quaerat.', 'Molestiae dolores provident quam temporibus.', 971083, 18,
        '판매중'),
       ...
       (5, 13, 4, 67, '2022-11-18 19:30:42', 'Id.', 'Harum eius libero. Temporibus fugiat libero esse.', 63142, 10,
        '판매중'),
       (3, 7, 5, 68, '2023-05-06 11:10:38', 'Veritatis.', 'Asperiores voluptatem error eius aspernatur.', 60347, 4,
        '판매중'),
       ...
       (5, 2, 6, 79, '2022-11-17 03:26:17', 'Fuga.', 'Nihil nihil libero expedita eos in quas aliquam.', 26861, 24,
        '판매중'),
       ...
       (2, 11, 2, 89, '2022-12-25 07:53:17', 'Enim cum.', 'Mollitia quia voluptatibus architecto nesciunt.', 548409, 7,
        '판매중'),
       ...
       (4, 17, 3, 95, '2022-12-17 03:03:58', 'Debitis.', 'Voluptas laudantium id. Dolorum ea consequuntur.', 196200, 21,
        '판매중'),
       (3, 15, 4, 96, '2023-05-15 04:31:44', 'Eligendi.', 'Rem nesciunt error deserunt nihil repudiandae.', 796712, 5,
        '판매중'),
